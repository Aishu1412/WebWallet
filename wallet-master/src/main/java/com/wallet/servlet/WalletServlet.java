...
public class WalletServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			Wallet wallet = dbUtils.getUserWalletBalance(user.getQrid());
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Wallet userWallet = dbUtils.getUserWalletBalance(user.getQrid());
		
		Wallet updatedWallet = dbUtils.updateUserWalletBalance(user.getQrid(), userWallet.getCash()+cash);
